...
import { completeDeliverySchema } from "@/modules/delivery/domain/delivery";
...
export async function POST(
  ...
  try {
    ...
    const proof = validated.success ? validated.data.proofOfDelivery : undefined;
    ...
    return NextResponse.json({ error: err.message || "Failed to complete delivery" }, { status: 400 });
  }
}
